package com.gramup.lead.activity;
...
import static com.gramup.lead.activity.CorporateRegistrationActivity.USERINFO;
...
public class UserRegistrationActivity extends AppCompatActivity {
    ...
    private String Name="",Email="",Password="",Company="Gramup",Designation="Farmer",Mobile="",
            Experience="",Address="",Referal="te-032207";
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() {
            ...
            try {
                ...
                multipartEntity.addPart("referral_code",new StringBody(Referal));
